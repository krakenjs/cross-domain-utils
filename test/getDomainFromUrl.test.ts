...
test('getDomainFromUrl should get url protocol and domain for a simple http url', () => {
...
test('getDomainFromUrl should get url protocol and domain for a long https url', () => {
    const url =
...
test('getDomainFromUrl should get url protocol and domain for a url with non-www subdomain', () => {
...
test('getDomainFromUrl should get url protocol and IP of a file url ', () => {
